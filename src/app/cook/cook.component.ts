...
export class CookComponent {
  people = [
    { id:1, name:'The Hungry Hive', profession:'-BREAKFAST: Masala Dosa, Aloo Paratha, Poha(Rate: ₹150/hr)\n MAINS: Dal Makhani, Palak Paneer, Veg Biryani, Chole Bhature. (Rate: ₹200/hr) \n \n DESSERTS: Gulab Jamun, Rasmalai, Chocolate Brownie(Rate: ₹200/hr),', image:'../../assets/beauty-treatment/Screenshot 2024-09-24 140413.png'},
    { id:2, name:'Sizzle & Drizzle', profession:'SOUPS & SALADS: Tomato Basil Soup, Caesar Salad(Rate: ₹200/hr)\n MAINS: Sizzling Paneer Steak, Thai Green Curry with Jasmine Rice, Spinach Ricotta Pasta(Rate: ₹250/hr)\n DESSERTS: Molten Lava Cake, Cheesecake, Tiramisu', image:'../../assets/beauty-treatment/Screenshot 2024-09-24 140413.png'},
